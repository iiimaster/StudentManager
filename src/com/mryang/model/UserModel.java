...
public class UserModel {
     ...
     */
    public User Login(User loginUser, ArrayList<User> userList) throws SQLException {
        User user = null;
     ...
     */
    public boolean userNameExists(String userName, ArrayList<User> userList) throws SQLException {
     ...
     * @return 完整用户信息
     */
    public User Registered(User regUser, ArrayList<User> userList) throws SQLException {
        connection = JdbcUtils.getConnection();
